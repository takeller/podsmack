...
describe 'As a User' do
  before :each do
    @user = create(:user)
    @podcast = create(:podcast, user: @user, location: "Denver", podcast_uri: '123', name: 'podcast1', description: 'description1', active: true)
    @podcast2 = create(:podcast, user: @user, location: "NYC", podcast_uri: '1234', name: 'podcast2', description: 'description2', active: true)
    @podcast3 = create(:podcast, user: @user, location: "Denver", podcast_uri: '1235', name: 'podcast3', description: 'description3', active: true)
    @podcast4 = create(:podcast, user: @user, location: "Dallas", podcast_uri: '1236', name: 'podcast11', description: 'description4', active: true, adult_content: true)
